...
CREATE TABLE IF NOT EXISTS stored_material_info (
    ...
    foreign key (storage_related) references storages(id),
...
CREATE TABLE IF NOT EXISTS decrease_log (
    ...
    rel_strg integer,
    foreign key (rel_strg) references storages(id),
...
INSERT INTO stored_material_info (storage_related, material_related, material_quantity)
VALUES
(1, 1, 13),
(1, 2, 3),
(1, 3, 6),
...
INSERT INTO supply_log (datesupl, rel_strg, rel_supl, rel_material, material_quantity)
VALUES
('2003-05-23', 1, 1, 1, 6),
('2009-07-21', 2, 2, 3, 5);
